...
class fixed_wcnn_imbalanced(object):
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        model_name = 'fixed_wcnn_imbalanced'
        if model_name == 'fixed_wcnn_imbalanced':
            model = fixed_wcnn_imbalanced(x, y,
                                    is_training,
                                    keep_prob,
                                    input_num1=1920,
                                    kernel_number_1=16,
...
#        model.train(x, y, x_train_i, y_train_i, x_test_i, y_test_i, train_weight, class_weight, ir_overall, train_parameter)
        ...
        #cost_CNN
#        confusion_matrix, accr_confusion1, f_score_out, g_mean_out, test_accr, train_accr = model.train(x, y, f, x_train_i, y_train_i, x_test_i, y_test_i, train_weight, class_weight, ir_overall, train_parameter)
        #CNN
